...
;are almost always performed with limited precision. This makes our test inadequate
...
;how guess changes from one iteration to the next and to stop when the change is a very small fraction
